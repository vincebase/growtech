...
import top from "../../public/about-us_hero-image.png"
    ...
    <div>
          <section className="text-gray-600 body-font">
                <div className="container mx-auto flex py-10 px-10 items-center justify-center flex-col">
                    <Image 
                    className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded-3xl" alt="hero" 
                    src={top}
                    width={1165}
                    height={604}
                    />
                    <div className="text-center lg:w-2/3 w-full">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 py-5 font-medium text-gray-900">Our Company</h1>
